...
class Discriminator(nn.Module):
    ...
    def __init__(
        ...
        self.Linear = nn.Sequential(nn.Linear(in_features=9, out_features=1))
    ...
    def forward(self, input_tensor: Tensor) -> tuple[Tensor, Tensor]:
        ...
        classifier = self.Linear(classifier)
...
class Generator(nn.Module):
    ...
    def forward(self, input_tensor: Tensor) -> tuple[Tensor, Tensor, Tensor]:
        ...
        return gen_image, latent_i


class ArcadeModel(nn.Module):
    """Arcade Model.
    ...
    def forward(self, batch: Tensor) -> tuple[Tensor, Tensor, Tensor, Tensor] | Tensor:
        ...
        """
        fake, latent_i = self.generator(batch)
        ...
        for index in range(batch.shape[0]):
            out_temp.append(self.loss(batch[index], fake[index]))
