...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        # print(min(input_size) // 2, input_size)
...
class GanomalyModel(nn.Module):
    ...
    def forward(self, batch: Tensor) -> tuple[Tensor, Tensor, Tensor, Tensor] | Tensor:
        ...
        # print(latent_i.shape, latent_o.shape)
        if self.training:
...
# summary(model=GanomalyModel(input_size=(40, 40), num_input_channels=3, n_features=64, latent_vec_size=128), input_size=(3, 40, 40), batch_size=8, device='cpu')