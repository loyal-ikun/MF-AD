...
class Traffic_Test_DataDataset(torch.utils.data.Dataset):
    """
    ...
    def get_image_data(self):
        ...
        classname = ["good" for _ in range(num // 2)] + ["bad" for _ in range(num // 2)]
        is_anomaly = [0 for _ in range(num // 2)] + [1 for _ in range(num // 2)]
