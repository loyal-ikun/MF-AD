...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument("--config", type=str, default='hparams.yaml', required=False, help="Path to a model config file")
    parser.add_argument("--weight_file", type=str, default="model.ckpt")
